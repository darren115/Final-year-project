...
//
//When display object is created Intialise the display.
//
display::display()
{
...
void display::drawGrid(SDL_Surface *screen, int tileWidth, int tileHeight, int screenWidth, int screenHeight, int tilesAcross, int tilesUp)
{
    SDL_Rect dest;
    
    for (int i = 0; i < tilesAcross; i++)
    {
        dest.x = (tileWidth*i)-1;
        dest.y = 0;
        dest.w = 1;
        dest.h = screenHeight;
